...
wire [1:0] chunk_insts_1_chunk_insts_5_a;

assign clk = 1'd0;
assign chunk_insts_1_chunk_insts_5_a[1] = chunk_insts_3_button_o;
assign chunk_insts_1_chunk_insts_5_a[0] = chunk_insts_1_button_o;
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_1_LOC_INSTS_CHUNK_INSTS_1
    if ((chunk_insts_1_debounce_cnt == 0)) begin
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_3_LOC_INSTS_CHUNK_INSTS_1
    if ((chunk_insts_3_debounce_cnt == 0)) begin
...
always @(fsm_state) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_4_C
    case (fsm_state)
        2'b00: begin
            outputs_o = 1;
        end
...
assign dbnc_inputs = chunk_insts_1_chunk_insts_5_a;
